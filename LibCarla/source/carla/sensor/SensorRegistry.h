...
class AVisCamera;
class ASpecularCamera;
class ALidarIntensityCamera;
class AMatCamera;
class ARoughnessCamera;
class AMetallicCamera;
class ARssSensor;
...
namespace sensor {
  ...
  using SensorRegistry = CompositeSerializer<
    ...
    std::pair<AVisCamera *, s11n::ImageSerializer>,
    std::pair<ASpecularCamera *, s11n::ImageSerializer>,
    std::pair<ALidarIntensityCamera *, s11n::ImageSerializer>,
    std::pair<AMatCamera *, s11n::ImageSerializer>,
    std::pair<ARoughnessCamera *, s11n::ImageSerializer>,
    std::pair<AMetallicCamera *, s11n::ImageSerializer>,
